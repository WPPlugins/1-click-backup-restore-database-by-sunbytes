	...
	<div id="poststuff">
		<div class="metabox-holder">
			...
			<div id="post-body-content">
				...
				<div class="pl-copyright"><?php printf( __( 'Created by <a href="%s" target="_blank">Sunbytes</a> - Web Development Services. You can send your question to: development@sunbytes.vn', 'sbocbr' ), 'http://sunbytes.nl' ); ?></div>
...
<script type="text/javascript">
	jQuery(document).ready(function ($) {
		...
		//var TIMESTAMP = <?php //echo current_time( 'timestamp' ); ?>//000;
		//
