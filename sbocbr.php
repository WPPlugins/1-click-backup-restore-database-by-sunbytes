<?php
/**
 * Plugin Name: 1-click Backup & Restore Database by Sunbytes
 * Description: Backup & Restore your current database with one-click.
 * Version: 1.0.2
...
class Sbocbr {
	...
	function initialize() {
		...
		$this->settings = array(
			// basic
			'name'          => __( '1-Click Backup & Restore Database by Sunbytes', 'sbocbr' ),
	...
	function admin_menu() {
		add_menu_page( __( '1-click Backup & Restore Database by Sunbytes', 'sbocbr' ), __( '1-Click Backup DB', 'sbocbr' ), $this->settings['capability'], 'sbocbr-main', array(
			$this,
			'page_view'
		), 'dashicons-backup' );
	}
